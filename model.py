...
model.add(Convolution2D(14,5,5,activation='relu'))
model.add(MaxPooling2D())
model.add(Convolution2D(16,3,3,activation='relu'))
model.add(MaxPooling2D())
model.add(Convolution2D(18,2,2,activation='relu'))
...
model.compile(loss='mse', optimizer='adam')
model.fit(X_train, y_train, validation_split=0.2, shuffle=True, nb_epoch=1, batch_size=8)
